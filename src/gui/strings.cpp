...
std::stringstream StringsElement::openXMLStream(const std::string &filename) const {
...
pugi::xml_document StringsElement::readXMLDocument(std::stringstream &is) const {
  auto logger{spdlog::get(oo::LOG)};
