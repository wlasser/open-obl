#ifndef OPENOBLIVION_PERSISTENT_REFERENCE_LOCATOR_HPP
#define OPENOBLIVION_PERSISTENT_REFERENCE_LOCATOR_HPP
...
#endif // OPENOBLIVION_PERSISTENT_REFERENCE_LOCATOR_HPP
